    ...
    return (
        <div className=' pt-4 m-4 flex justify-between w-3/4 mx-auto align-center'>
            <button data-testid='prev'
                ...
                disabled={currentPage === 1} onClick={()=>handlePageChange(currentPage-1)}>prev</button>
            <p>page {currentPage} of {totalPage}</p>
            <button data-testid='next' className='p-2 bg-violet-900 font-semibold text-white hover:bg-violet-400' disabled={currentPage >= totalPage} 
